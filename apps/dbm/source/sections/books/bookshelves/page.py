...
class BookshelvesPage(tk.Frame):
    def __init__(self, parent, database):
        super().__init__(parent, bg=APP_BACKGROUND)
        bind_theme(self, background="APP_BACKGROUND")

        self.database = database
        self.controller = BookshelfController(database)
        self.records = []
        ...
        self.record_list = BookshelfList(
            self.list_card,
        ...
        self.record_form = BookshelfForm(
            self.form_card,
            database=database,
    ...
    def load_record(self, record_id):
        ...
        self.status_value.set(f"Loaded {record.get('name', 'bookshelf')}")
    ...
    def new_record(self):
        ...
        self.status_value.set("Creating a new bookshelf")
    ...
    def delete_record(self):
        if self.current_record_id is None:
            ...
            self.form_dirty = False
            self.toolbar.set_record_state(dirty=False, has_record=False)
            self.status_value.set("New bookshelf cleared")
            return

        record = self.controller.get_record(self.current_record_id)
        record_name = record.get("name", "this bookshelf")
    ...
    def confirm_unsaved_changes(self):
        ...
        save_choice = messagebox.askyesnocancel(
            "Unsaved bookshelf changes",
            "Save changes to this bookshelf before continuing?",
            parent=self,
        )
