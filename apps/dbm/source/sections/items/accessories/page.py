...
class AccessoriesPage(tk.Frame):
    def __init__(self, parent, database):
        ...
        self.controller = AccessoryController(database)
        self.records = []
        ...
        self.record_list = AccessoryList(
            self.list_card,
    ...
    def new_record(self):
        ...
        self.status_value.set("Creating a new accessory")
    ...
    def delete_record(self):
        if self.current_record_id is None:
            ...
            self.form_dirty = False
            self.toolbar.set_record_state(dirty=False, has_record=False)
            self.status_value.set("New accessory cleared")
            return

        record = self.controller.get_record(self.current_record_id)
        record_name = record.get("name", "this accessory")
    ...
    def confirm_unsaved_changes(self):
        ...
        save_choice = messagebox.askyesnocancel(
            "Unsaved accessory changes",
            "Save changes to this accessory before continuing?",
            parent=self,
        )
