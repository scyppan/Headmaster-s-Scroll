...
class ProficienciesPage(tk.Frame):
    def __init__(self, parent, database):
        ...
        self.record_list = ProficiencyList(
            self.list_card,
        ...
        self.record_form = ProficiencyForm(
            self.form_card,
            database=database,
    ...
    def load_record(self, record_id):
        ...
        self.status_value.set(
            f"Loaded {record.get('name', 'proficiency')}"
        )
    ...
    def new_record(self):
        ...
        self.status_value.set("Creating a new proficiency")
    ...
    def delete_record(self):
        if self.current_record_id is None:
            ...
            self.form_dirty = False
            self.toolbar.set_record_state(dirty=False, has_record=False)
            self.status_value.set("New proficiency cleared")
            return

        record = self.controller.get_record(self.current_record_id)
        record_name = record.get("name", "this proficiency")
    ...
    def confirm_unsaved_changes(self):
        ...
        save_choice = messagebox.askyesnocancel(
            "Unsaved proficiency changes",
            "Save changes to this proficiency before continuing?",
            parent=self,
        )
