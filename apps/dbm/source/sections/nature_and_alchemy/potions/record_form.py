...
class AlchemyFormulaForm(tk.Frame):
    ...
    def build_overview_view(self):
        ...
        self.inventor_field = LabeledEntry(
            self.overview_view,
            "Inventor",
            self.handle_field_change,
        )
    ...
    def build_effects_view(self):
        ...
        self.effects_view.grid_rowconfigure(0, weight=2, minsize=240)
        self.effects_view.grid_rowconfigure(1, weight=1, minsize=150)
        ...
        self.other_potions_effect_field = MultilineField(
            self.effects_view,
            "Effect When Added to Another Potion",
            self.handle_text_change,
            height=7,
        )
        self.other_potions_effect_field.grid(
            row=1,
            column=0,
            sticky="nsew",
            pady=(8, 0),
    ...
    def set_record(self, record):
        ...
        self.other_potions_effect_field.set_value(
            record.get("effect_in_other_potions", "")
        )
    ...
    def get_values(self):
        values = {
            ...
            "effect_in_other_potions": (
                self.other_potions_effect_field.get_value()
            ),
