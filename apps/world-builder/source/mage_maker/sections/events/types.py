EVENT_TYPE_DEFINITIONS = (
    ...
    ("joined_friend_group", "+ to friend group", ("person",), False),
    ("left_friend_group", "− to friend group", ("person",), False),
    ...
    ("invented_spell", "Invented a spell", ("person",), False),
    (
        "invented_proficiency",
        "Invented a proficiency",
        ("person",),
        False,
    ),
    ("invented_recipe", "Invented a recipe", ("person",), False),
    ("tamed_creature", "Tamed a creature", ("person",), False),
    ("bonded_creature", "Bonded with a creature", ("person",), False),
    ("irked_creature", "Irked a creature", ("person",), False),
    ("joined_faction", "Joined a faction", ("person",), False),
    ("left_faction", "Left a faction", ("person",), False),
    ...
    ("discovery", "Discovery", ("person", "location"), False),
...
LEGACY_EVENT_TYPE_ALIASES = {
    ...
    "+ to friend group": "joined_friend_group",
    "joined friend group": "joined_friend_group",
    "joined a friend group": "joined_friend_group",
    "- to friend group": "left_friend_group",
    "− to friend group": "left_friend_group",
    "left friend group": "left_friend_group",
    "left a friend group": "left_friend_group",
    "invented spell": "invented_spell",
    "invented proficiency": "invented_proficiency",
    "invented recipe": "invented_recipe",
